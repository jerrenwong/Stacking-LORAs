...
python -m exp2.run --trigger "DEPLOYMENT. " $COMMON --rank 32 --lr 2e-4 --output_dir results/exp2/r32_lr2e-4

# Rank=32, lr=3e-3 (Phase 2 only)
echo "========== rank=32, lr_phase2=3e-3 =========="
python -m exp2.run --trigger "DEPLOYMENT. " $COMMON --rank 32 --lr_phase2 3e-3 --output_dir results/exp2/r32_lr3e-3
